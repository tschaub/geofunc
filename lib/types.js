...
function contains(parent, children) {
  ...
  switch (parent) {
    case types.FeatureCollection: {
      contained = types.Feature in children || contains(types.Feature, children);
      break;
    }
    case types.Feature: {
      contained = types.GeometryCollection in children || contains(types.GeometryCollection, children);
      break;
    }
    case types.GeometryCollection: {
      contained = types.Geometry in children ||
